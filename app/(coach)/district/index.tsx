...
export default function YourDistrictScreen() {
  ...
  // Real team IDs from database - District 7-5A Division I
  const standings = [
    { team_id: 15, team: "Highland Park", mascot: "Scots", wins: 5, losses: 0, pf: 275, pa: 180, streak: "W5" },
    { team_id: 25, team: "Red Oak", mascot: "Hawks", wins: 4, losses: 1, pf: 210, pa: 195, streak: "W2" },
    { team_id: 22, team: "Midlothian", mascot: "Panthers", wins: 3, losses: 1, pf: 198, pa: 165, streak: "L1" },
    { team_id: 31, team: "Tyler", mascot: "Lions", wins: 2, losses: 3, pf: 185, pa: 220, streak: "W1" },
    { team_id: 16, team: "Joshua", mascot: "Owls", wins: 1, losses: 4, pf: 155, pa: 215, streak: "L3" },
    { team_id: 5, team: "Burleson Centennial", mascot: "Spartans", wins: 2, losses: 3, pf: 170, pa: 205, streak: "L1" },
    { team_id: 6, team: "Cleburne", mascot: "Yellow Jackets", wins: 0, losses: 6, pf: 120, pa: 280, streak: "L6" },
  ];

  const lastWeeksGames = [
  ...
  return (
    ...
    >
      <View style={{ flexDirection: "row", gap: 20, flex: 1 }}>
        ...
        {/* Left Column - Standings (3/5 width) */}
        <View style={{ flex: 3 }}>
          <View style={{ backgroundColor: "#3a3a3a", borderRadius: 16, padding: 24, height: "100%" }}>
            ...
            <View style={{ flexDirection: "row", paddingVertical: 10, borderBottomWidth: 2, borderBottomColor: "#555", marginBottom: 12, paddingHorizontal: 10 }}>
              <Text style={{ color: "#999", fontSize: 14, fontFamily: "NeueHaas-Bold", flex: 4 }}>TEAM</Text>
              <Text style={{ color: "#999", fontSize: 14, fontFamily: "NeueHaas-Bold", width: 50, textAlign: "center" }}>W-L</Text>
              <Text style={{ color: "#999", fontSize: 14, fontFamily: "NeueHaas-Bold", width: 50, textAlign: "center" }}>PF</Text>
              <Text style={{ color: "#999", fontSize: 14, fontFamily: "NeueHaas-Bold", width: 50, textAlign: "center" }}>PA</Text>
              <Text style={{ color: "#999", fontSize: 14, fontFamily: "NeueHaas-Bold", width: 70, textAlign: "center" }}>STREAK</Text>
            </View>

            {/* Standings Rows - Clickable */}
            {standings.map((team, idx) => (
              <View key={team.team_id}>
                <Pressable
                  onPress={() => handleTeamPress(team.team_id)}
                  style={({ pressed }) => ({
                    flexDirection: "row",
                    paddingVertical: 14,
                    backgroundColor: team.team === "Joshua" ? "#0066cc22" : pressed ? "#ffffff10" : "transparent",
                ...
                >
                  ...
                  <Text style={{ color: "#fff", fontSize: 16, fontFamily: "NeueHaas-Roman", width: 50, textAlign: "center" }}>
        ...
        {/* Right Column - Last Week's Games (2/5 width) */}
        <View style={{ flex: 2 }}>
          <View style={{ backgroundColor: "#3a3a3a", borderRadius: 16, padding: 24, height: "100%" }}>
            <Text style={{ color: "#fff", fontSize: 24, fontFamily: "NeueHaas-Bold", marginBottom: 20 }}>
              Last Week's Games
